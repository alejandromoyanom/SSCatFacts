...
import { getPopularCatFacts } from "../api";

function PopularFactsList({ triggerRefresh }) {
  // triggerRefresh para forzar la actualización
  ...
  const fetchPopularFacts = async () => {
    ...
    try {
      ...
      setError("Error al cargar hechos populares.");
